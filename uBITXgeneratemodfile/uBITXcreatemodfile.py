...
#         # this use of the "format" modifier is required because if we replaced the "{}" with userSettingName
...
#         # userSetting name and the quote marks remain. I could have swapped the single and double quotes and
...
#                     userSettingTag = EEPROMroot.find('.//SETTING[@NAME="QSO_CALLSIGN"]')
